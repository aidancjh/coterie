  ...
  return (
    ...
    >
      <style>{`
        ...
        .wl-faq-a-inner p { margin:0 0 13px; font-size:13.5px; font-weight:500; line-height:1.5; color:#5B6B7E; }
      ...
      <div
        ...
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(46% 40% at 50% 46%, rgba(250,252,254,0.92) 0%, rgba(250,252,254,0.7) 38%, rgba(250,252,254,0) 70%)",
        }}
      />
      ...
      >
        ...
        <div className="wl-formwrap" style={{ width: "100%", maxWidth: "clamp(380px, 34vw, 640px)", marginTop: "clamp(28px,3vw,48px)" }}>
          {submitted ? (
            ...
            >
              ...
              <span style={{ fontSize: "clamp(15px,1.1vw,19px)", fontWeight: 600, color: "#0F1B2D" }}>{message}</span>
            </div>
          ) : (
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 13, marginTop: "clamp(22px,2.2vw,38px)" }}>
          ...
          <span style={{ fontSize: "clamp(13.5px,1vw,17px)", fontWeight: 600, color: "#5B6B7E" }}>
            Join 900+ players already on the list
          </span>
        </div>
